...
pub fn set(self: *Self, key: *Object.ObjectString, value: Value) bool {
...
pub fn get(self: *Self, key: *Object.ObjectString) ?Value {
...
pub fn delete(self: *Self, key: *Object.ObjectString) bool {
...
pub fn findString(self: *Self, buffer: []const u8, hash: u32) ?*Object.ObjectString {
    if (self.count == 0) return null;
...
fn findEntry(self: *Self, key: *Object.ObjectString) *Entry {
